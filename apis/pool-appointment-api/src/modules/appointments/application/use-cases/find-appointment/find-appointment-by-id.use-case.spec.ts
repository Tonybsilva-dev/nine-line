...
describe('FindAppointmentByIdUseCase', () => {
  ...
  beforeEach(() => {
    ...
    findAppointmentByIdUseCase = new FindAppointmentByIdUseCase(
  ...
  it('should find appointment by ID', async () => {
    ...
    const result = await findAppointmentByIdUseCase.execute(
  ...
  it('should find appointment with different statuses', async () => {
    ...
    const confirmedResult = await findAppointmentByIdUseCase.execute(
      confirmedAppointment.id.toString(),
    );
